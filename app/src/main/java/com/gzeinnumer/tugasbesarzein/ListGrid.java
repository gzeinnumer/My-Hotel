...
import com.gzeinnumer.tugasbesarzein.Adapter.GridAdapter;
...
public class ListGrid extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =inflater.inflate(R.layout.fragment_list_grid, container, false);
        context = view.getContext();

        swipe = view.findViewById(R.id.swipeGrid);
    ...
    private void initRecyclerView() {
        ...
        adapter=new GridAdapter(view.getContext(),data.listHotel);
