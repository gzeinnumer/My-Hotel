...
import com.gzeinnumer.tugasbesarzein.LGHotel;
...
public class LinearAdapter extends RecyclerView.Adapter<LinearAdapter.MyHolder>{
    private Context mContext;
    private ArrayList<ModelHotel> mList = new ArrayList<>();
    ModelHotel model;

    public LinearAdapter(Context context, ArrayList<ModelHotel> list) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_linear,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, final int i) {
        model = mList.get(i);
        LGHotel.items.add(model.getNama());
